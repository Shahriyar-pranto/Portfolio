    ...
    <div ref={ref} className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {visibleProjects.map((project, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <div className="text-purple-600 dark:text-purple-400 mb-2">{project.category}</div>
        ...
        {hasMore && (
          ...
          >
            <button
              className="px-6 py-3 bg-gray-900 dark:bg-purple-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-purple-700 transition-colors"
